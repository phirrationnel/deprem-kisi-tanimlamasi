...
ali = face_recognition.load_image_file("ali.jpg")
...
#ufuk_yüz = face_recognition.face_encodings(ufuk)[0]
...
while True:
    ...
    if process_this_frame:
        ...
        dikdörtgen = cv2.resize(frame1, (0, 0), fx=0.25, fy=0.25)
    ...
    cv2.imshow('Kamera 2', frame1)

    if cv2.waitKey(1) & 0xFF == ord('q'):
        break

with open('okuluniçindeolanlar.txt', 'w') as fp:
    for item in my_set:
        fp.write("%s\n" % item)
